...
def main(
    ...
    # Get the PMC count
    # Note: This file is generated by the `generate_pmc_count.py` script
    if not Path(pmc_count_path).exists():
        raise FileNotFoundError(
            f"PMC count file not found: {pmc_count_path}. Run `generate_pmc_count.py` first."
        )
